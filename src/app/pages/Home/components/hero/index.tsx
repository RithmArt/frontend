      ...
      <Grid container spacing={{ lg: 8, xl: 8 }}>
        <Grid item xs={12} sm={12} md={12} lg={4} xl={4}>
          <TitleDescActionsWrapper>
            <TitleAndDescWrapper>
              <Title>
                RITHM Art Collective
              </Title>
              <Description>
                The 1st Algorithmic Art Collective built on the Avalanche network to support the development, curation and adoption of Generative, Computational and AI art
              </Description>
            </TitleAndDescWrapper>
            <ActionsWrapper>
